...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        d_layer_2=d_pred_y*pred_y*(1-pred_y)
        grad_layer_2=output_layer_1_act.T.dot(d_layer_2)
        d_layer_1_act=d_layer_2.dot(MLP_layer_2.T)
        d_layer_1=d_layer_1_act*(1-output_layer_1_act)*output_layer_1_act
        grad_layer_1=input_vector.T.dot(d_layer_1)
